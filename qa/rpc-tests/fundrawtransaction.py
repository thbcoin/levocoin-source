...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid levocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid levocoin address" in e.error['message'])
