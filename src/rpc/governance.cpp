...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in levocoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("levocoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Levocoin features */
    { "levocoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "levocoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "levocoin",               "gobject",                &gobject,                true,  {} },
    { "levocoin",               "voteraw",                &voteraw,                true,  {} },
