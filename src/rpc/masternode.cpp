...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Levocoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "levocoin",               "masternode",             &masternode,             true,  {} },
    { "levocoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "levocoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "levocoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "levocoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "levocoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
