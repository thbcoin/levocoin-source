    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LEVO-light"), QVariant("light"));
    ui->theme->addItem(QString("LEVO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LEVO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("LEVO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("LEVO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LEVO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LEVO-traditional"), QVariant("trad"));
