...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Levocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and levocoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Levocoin Core"));
    ...
    openAction->setStatusTip(tr("Open a levocoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Levocoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Levocoin Core"); // default title
