...
This mechanism has been integrated into Bitcore-Node-Levocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/levocoinpay/insight-api-levocoin#web-socket-api](https://github.com/levocoinpay/insight-api-levocoin#web-socket-api)
* API: [https://github.com/levocoinpay/insight-api-levocoin#instantsend-transactions](https://github.com/levocoinpay/insight-api-levocoin#instantsend-transactions)
...
By default, the Levocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Levocoin Core daemon:
